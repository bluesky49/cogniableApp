              ...
              <div>
                <Row>
                  <Col xs={{ span: 4 }} lg={{ span: 4 }}>
                    <Form {...layout}>
                      <Select placeholder="search learner" onSelect={this.handleChange} allowClear>
                  ...
                  <Col xs={{ span: 4 }} lg={{ span: 4 }}>
                    <Form {...layout}>
                      <Select placeholder="Domain" onSelect={this.handleChange} allowClear>
                  ...
                  <Col xs={{ span: 4 }} lg={{ span: 4 }}>
                    <Form {...layout}>
                      <Select placeholder="Target Area" onSelect={this.handleChange} allowClear>
                        <Option value="">1</Option>
                        <Option value="">2</Option>
                        <Option value="">3</Option>
                      </Select>
                  ...
                  <Col xs={{ span: 4 }} lg={{ span: 4 }}>
                    <Search placeholder="search keyword " onSearch={value => console.log(value)} />
                  </Col>
                  <Col xs={{ span: 4 }} lg={{ span: 4 }}>
                    <Form {...layout}>
        ...
        <div className="col-sm-7">
          <div className="card">
            <div className="card-body">
              ...
              <Table rowSelection={rowSelection1} columns={column1} dataSource={data1} />,
            </div>
          </div>
        </div>
        <div className="col-sm-7">
          <div className="card">
            <div className="card-body">
              ...
              <Table rowSelection={rowSelection2} columns={column2} dataSource={data2} />,
            </div>
          </div>
        </div>
      </div>
