...
class TharepistStudentsSessions extends PureComponent {
    constructor(props) {
        super(props)
        this.state = {
            // isClicked: false,
            ...
            for (let i = 0; i < stateData.students.length; i += 1) {
                cards.push(
                    <>
                        <div
                            role="presentation"
                            onClick={() => { this.setClickHandler(stateData.students[i].node) }}
                        >
                            <LearnerCard
    ...
    learnerSessions = () => {
        return (
            <div style={parentCardStyle}>
                <div style={cardStyle}>
                    <Title style={{ fontSize: 20, lineHeight: '27px' }}>Learner Previous Sessions</Title>
                    {/* <a href="javascript: void(0);" onClick={this.fetchLearnerSessions}>
                        <div style={targetMappingStyle}>
                            <Title style={{ fontSize: '20px', lineHeight: '27px', display: 'block' }}>Today&apos;s Sessions</Title>
                            <p style={{ display: 'block', marginTop: '5px', marginBottom: '-5px' }}><i>Click here to start Sessions </i></p>
                        </div>
                    </a> */}
    ...
    selectedLearnerSessions = () => {
        ...
        return (
            <div style={parentCardStyle}>
                <div style={cardStyle}>
                    <Title style={{ fontSize: 20, lineHeight: '27px' }}>Learner Today&apos;s Sessions</Title>
                    <LearnerSession key={studentId} />
                </div>
            </div>
        )
    }
...
export default TharepistStudentsSessions
