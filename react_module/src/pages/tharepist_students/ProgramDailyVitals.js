        ...
        return (
            <div style={parentCardStyle}>
                <div style={cardStyle}>
                    ...
                    <a href="/#/abc/">
                        <div style={targetMappingStyle}>
                            <Title style={{ fontSize: '20px', lineHeight: '27px', display: 'block' }}>ABC Data</Title>

                            <p style={{ display: 'block', marginTop: '5px', marginBottom: '-5px' }}><i>Click here to record ABC data</i></p>
                        </div>
                    </a>
                </div>
            </div>
