            ...
            <div>
              <Form>
                ...
                <div className="card">
                  ...
                  >
                    <Input name="motherContact" placeholder="Your answer" style={{width:"70%"}} />
                  </Form.Item>               
                </div>
                ...
                <div className="card">
                  ...
                  >
                    <Input name="fatherContact" placeholder="Your answer" style={{width:"70%"}} />
                  </Form.Item>               
                </div>
                ...
                <div className="card">
                  ...
                  >
                    <Input name="formOftherapies" placeholder="Your answer" style={{width:"70%"}} />
                  </Form.Item>               
                </div>
                ...
                <div className="card">
                  ...
                  >
                    <Input name="modeOfcommunications" placeholder="Your answer" style={{width:"70%"}} />
                  </Form.Item>               
                </div>
