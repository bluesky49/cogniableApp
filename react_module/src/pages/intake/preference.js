      ...
      <Authorize roles={['admin']} redirect to="/dashboard/beta">
        ...
        <div className="row justify-content-md-center">
          ...
          <div className="col-sm-8">
            <div className="card">
              <p style={{fontSize:"25px",textAlign:"center",backgroundColor:"#3956C4",color:"white"}}>Preference Assessment</p>
              ...
              <div style={{marginLeft:"5%"}}>
                <Form>
                  ...
                  >
                    <Input name="toys" placeholder="Your answer" onChange={this.handleChange} value={toys} style={{width:"70%"}} />
                  </Form.Item>
                  <hr />
                  ...
                  >
                    <Input name="activities" placeholder="Your answer" onChange={this.handleChange} value={activities} style={{width:"70%"}} />
                  </Form.Item> 
                  <hr />
                  <Form.Item 
                  ...
                  >
                    <Input name="edibles" placeholder="Your answer" onChange={this.handleChange} value={edibles} style={{width:"70%"}} />
                  </Form.Item> 
                  <hr />
                  <Form.Item 
                  ...
                  >
                    <Input name="acknowledgement" placeholder="Your answer" onChange={this.handleChange} value={acknowledgement} style={{width:"70%"}} />
                  </Form.Item>               
