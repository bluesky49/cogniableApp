      ...
      <Authorize roles={['admin']} redirect to="/dashboard/beta">
        ...
        <div className="row justify-content-md-center">
          ...
          <div className="col-sm-7">
            <div className="card">
              <p style={{fontSize:"25px",textAlign:"center",backgroundColor:"#3956C4",color:"white"}}>Medical History</p>
              <div style={{marginLeft:"5%"}}>
                <Form>
                  ...
                  >
                    <Input name="lernerDiagnosis" placeholder="Your answer" onChange={this.handleChange} value={lernerDiagnosis} style={{width:"70%"}} />
                  </Form.Item>               
                  ...
                  >
                    <InputNumber name="age" min={1} max={100000} defaultValue={0} value={age} onChange={onChange} style={{width:"70%"}} />
                  </Form.Item>
                  ...
                  >
                    <Checkbox.Group style={{ width: '100%',fontSize:"25px" }} onChange={onChange}>
                      ...
                      <Checkbox value="Asthma">Asthma</Checkbox><br />
                      <Checkbox value="sleepingProblems">Sleeping problems</Checkbox><br />
                      <Checkbox value="gastrointestinalIssue">Gastrointestinal issue</Checkbox><br />
                      <Checkbox value="infection">Infection(ear,skin etc)</Checkbox><br />
                      <Checkbox value="seizures">Seizures</Checkbox><br />
                      <Checkbox value="anxiety">Anxiety</Checkbox><br />
                      <Checkbox value="ocd">OCD</Checkbox><br />
                      <Checkbox value="hyperactivity">Hyperactivity</Checkbox><br />
                      <Checkbox value="other">Other</Checkbox><br />
                    </Checkbox.Group>
