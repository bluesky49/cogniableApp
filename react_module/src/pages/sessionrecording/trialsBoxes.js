...
class TrialsList extends Component {
  ...
  render() {
    ...
    const colorList = ['#4BAEA0', '#FF8080', '#4BAEA0', '#FF9C52', '#FF8080', '#FF8080', '#FF9C52', '#FF9C52', '#4BAEA0', '#4BAEA0']
    ...
    const stimuusList = TargetResponse[TargetActiveId].peak

    const Trials = []
    let i = 0
    for (i = 0; i < trails; i++) {
      Trials.push(
        <div style={{display: 'inline-block', marginRight: '8px', marginLeft: '8px', textAlign: 'center'}}>
            <span style={{display:'block'}}>Stimulus {stimuusList[i].sdIndex + 1}</span>
