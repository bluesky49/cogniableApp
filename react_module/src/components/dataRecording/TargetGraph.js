...
class TargetGraph extends React.Component {
  ...
  render() {
    ...
    const { datarecording: { TargetList, TargetInitialValue, TargetListLength, TargetActiveKey, Correct, Incorrect } } = this.props;
        ...
        <>
            <Collapse bordered={false} defaultActiveKey={['1', '3']}>
              <Panel header="Target Video" key="1">
                ...
                <iframe width="100%" height="200" title="0" src="https://player.vimeo.com/video/401778268/3de9225a70" webkitallowfullscreen mozallowfullscreen allowfullscreen />
