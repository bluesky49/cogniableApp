      ...
      <>
        ...
        <p style={correctIncorrectDiv}>
          <Button
            ...
            style={{ padding: '20px auto', marginRight: '5px', width: '70px', height: '50px' }}
          ...
          <Button
            ...
            style={{ padding: '8px auto', width: '70px', height: '50px', marginTop: '10px' }}
        ...
        <div style={{ border: '1px solid #f2f2f2', padding: '10px', borderRadius: '5px' }}>
          ...
          {sdName.map((item, key) => (
            <Row>
              <Col sm={4}>
                <Button style={{ padding: '0 10px' }}>Stimulus {key + 1}</Button>
              </Col>{' '}
              <Col sm={20}>
                :{' '}
                <Button
                ...
                <Button style={{ width: '40px', padding: '0 10px' }}></Button>
                <Button style={{ width: '40px', padding: '0 10px' }}></Button>
                <Button style={{ width: '40px', padding: '0 10px' }}></Button>
                <Button style={{ width: '40px', padding: '0 10px' }}></Button>
                <Button style={{ width: '40px', padding: '0 10px' }}></Button>
