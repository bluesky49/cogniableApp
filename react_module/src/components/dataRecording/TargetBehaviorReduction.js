        ...
        <Form {...layout} style={{ padding: '0 80px' }}>
          <h6>
            ...
            <span style={{ float: 'right' }}>
              <Button style={{ width: '80px' }} onClick={() => this.removeIRT(irt)}>
                <Icon type="minus" />
              </Button>
              &nbsp;{' '}
              <Button onClick={() => this.addIRT(irt)} style={{ width: '80px' }}>
                <Icon type="plus" />
              </Button>
            </span>
          </h6>{' '}
          ...
          <h6>
            Frequency : {frequency}{' '}
            <span style={{ float: 'right' }}>
              <Button onClick={() => this.removeFrequency(frequency)} style={{ width: '80px' }}>
                <Icon type="minus" />
              </Button>
              &nbsp;{' '}
              <Button onClick={() => this.addFrequency(frequency)} style={{ width: '80px' }}>
                <Icon type="plus" />
              </Button>
            </span>
          </h6>
