    ...
    return (
      <Form {...layout} onSubmit={(e) => this.SubmitForm(e, this)} name="control-ref" style={{marginLeft:"10%"}}>
        ...
        <Form.Item label="Meal Time">
          {form.getFieldDecorator('mealTime', {rules: [{ required: true, message: 'Please pick a time!' }],})(
            <TimePicker onChange={this.setTime} name="mealTime" style={{ width: 250 }} />
          )}
        </Form.Item> 
        
        <Form.Item label="Meal Name">
          {form.getFieldDecorator('mealName', {rules: [{ required: true, message: 'Please provide Meal Name!' }],})(
            <Input placeholder="Enter Meal Name" name="mealName" style={{ width: 250 }} />
          )}
        </Form.Item>

        <Form.Item label="Meal Type">
          {form.getFieldDecorator('mealType', {rules: [{ required: true, message: 'Please Select an Option!!' }],})(
            <Select 
              style={{ width: 250 }} 
        ...
        <Form.Item label="Food Type">
          {form.getFieldDecorator('foodType', {rules: [{ required: true, message: 'Please Select an Option!!' }],})(
            <Select 
              showSearch 
              style={{ width: 250 }} 
        ...
        <Form.Item label="Water">
          {form.getFieldDecorator('waterIntake', {rules: [{ required: true, message: 'Please Enter Water Intake!' }],})(
