  ...
  render() {
    ...
    return (
      <Form onSubmit={e => this.handleSubmit(e, this)}>
        <Card
          bordered={false}
          style={{ backgroundColor: 'inherent', padding: '10px', width: '80%', margin: 'auto' }}
        >
        ...
        <Card
          bordered={false}
          style={{ marginTop: 16, padding: '10px', width: '80%', margin: 'auto' }}
        >
          ...
          <div style={{ left: '100px', width: '50%' }}>
            <ul style={{ listStyleType: 'none' }}>
              <li>
                <h6>
                  <span style={{ fontSize: '18px' }}>Morning : {morning} hr </span>{' '}
                  <span style={{ float: 'right' }}>
                    <Button style={{ width: '80px' }} onClick={() => this.removeMorning(morning)}>
                      <Icon type="minus" />
                    </Button>
                    &nbsp;{' '}
                    <Button onClick={() => this.addMorning(morning)} style={{ width: '80px' }}>
                      <Icon type="plus" />
                    </Button>
                  </span>
                </h6>{' '}
              ...
              <li>
                <h6>
                  <span style={{ fontSize: '18px' }}>Afternoon : {afternoon} hr </span>{' '}
                  <span style={{ float: 'right' }}>
                    <Button
                      style={{ width: '80px' }}
                      onClick={() => this.removeAfternoon(afternoon)}
                    >
                      <Icon type="minus" />
                    </Button>
                    &nbsp;{' '}
                    <Button onClick={() => this.addAfternoon(afternoon)} style={{ width: '80px' }}>
                      <Icon type="plus" />
                    </Button>
                  </span>
                </h6>{' '}
              ...
              <li>
                <h6>
                  <span style={{ fontSize: '18px' }}>Evening : {evening} hr </span>{' '}
                  <span style={{ float: 'right' }}>
                    <Button style={{ width: '80px' }} onClick={() => this.removeEvening(evening)}>
                      <Icon type="minus" />
                    </Button>
                    &nbsp;{' '}
                    <Button onClick={() => this.addEvening(evening)} style={{ width: '80px' }}>
                      <Icon type="plus" />
                    </Button>
                  </span>
                </h6>{' '}
