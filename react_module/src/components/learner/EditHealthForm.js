  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Form.Item label="Allergies" name="allergies" style={itemStyle}>
          <Select>
        ...
        <Form.Item label="Allergy observed" name="allergyOberver" style={itemStyle}>
          <Select>
        ...
        <Form.Item label="Allergic Reactions" name="allergicReactions" style={itemStyle}>
          <Select>
        ...
        <Form.Item label="observed Since Date:" name="observedDate" style={itemStyle}>
          <DatePicker />
        </Form.Item>

        <Form.Item label="Blood Pressure(Systolic)" name="BloodPresure" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Blood Pressure(Diastolic)" name="bloodPressure" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Pulse Rate" name="pulseRate" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Cholestrol" name="cholestrol" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Exercises" name="exercises" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Food & Drink" name="foodAndDrink" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Immunization" name="immunization" style={itemStyle}>
          <Select>
        ...
        <Form.Item label="Medication" name="medication" style={itemStyle}>
          <Input />
        </Form.Item>

        <Form.Item label="Menstruation" name="menstruation" style={itemStyle}>
          <Select>
            <Select.Option value="demo">demo</Select.Option>
            <Select.Option value="demo">demo</Select.Option>
          </Select>
