  ...
  render() {
    return (
      ...
      >
        ...
        <Form.Item label="Allergy observed" name="allergyOberver">
          <Select>
        ...
        <Form.Item label="Allergic Reactions" name="allergicReactions">
          <Select>
        ...
        <Form.Item label="observed Since Date:" name="observedDate">
          <DatePicker />
        </Form.Item>

        <Form.Item label="Blood Pressure(Systolic)" name="BloodPresure">
          <Input />
        </Form.Item>

        <Form.Item label="Blood Pressure(Diastolic)" name="bloodPressure">
          <Input />
        </Form.Item>
        ...
        <Form.Item label="Cholestrol" name="cholestrol">
          <Input />
        </Form.Item>
        ...
        <Form.Item label="Food & Drink" name="foodAndDrink">
          <Input />
        </Form.Item>

        <Form.Item label="Immunization" name="immunization">
          <Select>
        ...
        <Form.Item label="Menstruation" name="menstruation">
          <Select>
            <Select.Option value="demo">demo</Select.Option>
            <Select.Option value="demo">demo</Select.Option>
          </Select>
