...
import { Form, Button, Select, Input, DatePicker, notification } from 'antd'
...
class LongTerm extends React.Component {
  ...
  render() {
    const {
      form,
      goals: { GoalStatusList, GoalResponsibleList, StaffList },
    } = this.props
      ...
      >
        ...
        <Form.Item label="Therapist" style={itemStyle}>
          {form.getFieldDecorator('therapist', {
            rules: [{ required: true, message: 'Please select Therapist!' }],
          })(
            <Select
