                ...
                {data.map(row => (
                  <Col span={16} offset={4} style={{ marginTop: '20px' }}>
                    <Card style={{ borderRadius: '8px' }}>
                      ...
                      <h6>
                        {row.node.status.statusName} &emsp;{' '}
                        {row.node.environment ? row.node.environment.name : ''}
                      </h6>
                      <br />
                      <h6 style={{ display: 'inline' }}>
                        <PieChartOutlined /> Behaviour Graph
                      </h6>
                      <Button
                        type="link"
                        style={{ display: 'inline', float: 'right', color: 'red' }}
                      >
                        <CheckCircleFilled />
                        &nbsp;<b>Press To Record</b>
                      </Button>
