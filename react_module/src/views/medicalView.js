                  ...
                  <Panel header="Filter" key="1">
                    <Form.Item {...layout} label="Type">
                      <Select
                        style={{ width: '190px' }}
                        defaultValue="all"
                        onSelect={this.filterMedicalType}
                      >
                        <Select.Option value="all">All</Select.Option>
                        <Select.Option value="U2V2ZXJpdHlDb25kaXRpb25UeXBlOjE=">Mild</Select.Option>
                        <Select.Option value="U2V2ZXJpdHlDb25kaXRpb25UeXBlOjI=">
                          Moderate
                        </Select.Option>
                        <Select.Option value="U2V2ZXJpdHlDb25kaXRpb25UeXBlOjM=">
                          Severe
                        </Select.Option>
                      </Select>
                    </Form.Item>
          ...
          <Col span={divShow ? 10 : 18}>
            <Card>
              <Row>
                ...
                <Col span={6}>
                  <p style={{ float: 'right' }}>
                    <Button onClick={e => this.consoleValue(e)}>
                      ADD MEDICAL DATA <PlusOutlined />
                    </Button>
                  </p>
                </Col>
              </Row>
                  ...
                  <div className="text-left">
                    ...
                    <Col span={8} className="text-right">
                      <a>
                        <p>
                          {' '}
                          <strong>{medical.node.severity ? medical.node.severity.name : ''}</strong>
                        </p>
                      </a>
                    </Col>
                  </div>
