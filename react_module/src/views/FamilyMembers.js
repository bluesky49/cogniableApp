          ...
          <Col span={8}>
            <Card bordered={false} style={{ marginTop: 16 }}>
              <Button style={{ width: '100%', minHeight: '60px', fontSize: '20px' }}>
                <PictureOutlined style={{ float: 'left', width: 'auto' }} />
                Father <ArrowRightOutlined style={{ float: 'right' }} />
              </Button>
              <Button style={{ width: '100%', minHeight: '60px', fontSize: '20px', marginTop: 16 }}>
                <PictureOutlined style={{ float: 'left', width: 'auto' }} />
                Mother <ArrowRightOutlined style={{ float: 'right' }} />
              </Button>
              <Button style={{ width: '100%', minHeight: '60px', fontSize: '20px', marginTop: 16 }}>
                <PictureOutlined style={{ float: 'left', width: 'auto' }} />
                Sibling <ArrowRightOutlined style={{ float: 'right' }} />
              </Button>
              <Button style={{ width: '100%', minHeight: '60px', fontSize: '20px', marginTop: 16 }}>
                <PictureOutlined style={{ float: 'left', width: 'auto' }} />
                GrandFather <ArrowRightOutlined style={{ float: 'right' }} />
              </Button>
              <Button style={{ width: '100%', minHeight: '60px', fontSize: '20px', marginTop: 16 }}>
                <PictureOutlined style={{ float: 'left', width: 'auto' }} />
                Add Member <ArrowRightOutlined style={{ float: 'right' }} />
              </Button>
            </Card>
          </Col>
          <Col span={16}>
            <Card style={{ backgroundColor: 'inherit', marginTop: 16 }}>
              ...
              <h4 style={{ marginTop: 50 }}>
                Add family members details and time spent with kunal to allocate targets accordingly
              </h4>
              <Card
                bordered={false}
                style={{ marginTop: 50, backgroundColor: 'inherent', padding: '10px' }}
              >
                <Form layout="inline">
