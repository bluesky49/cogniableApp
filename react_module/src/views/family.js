          ...
          <Col span={6}>
            <Card bordered={false}>
              <Button style={buttonStyle}>
                ...
                Father <ArrowRightOutlined style={rightIconStyle} />
              </Button>
              <Button style={buttonStyle}>
                <PictureOutlined style={iconStyle} />
                Mother <ArrowRightOutlined style={rightIconStyle} />
              </Button>
              <Button style={buttonStyle}>
                <PictureOutlined style={iconStyle} />
                Sibling <ArrowRightOutlined style={rightIconStyle} />
              </Button>
              <Button style={buttonStyle}>
                <PictureOutlined style={iconStyle} />
                GrandFather <ArrowRightOutlined style={rightIconStyle} />
              </Button>
              <Button style={buttonStyle}>
                <PictureOutlined style={iconStyle} />
                Add Member <ArrowRightOutlined style={rightIconStyle} />
              </Button>
            </Card>
          </Col>
          <Col span={18}>
