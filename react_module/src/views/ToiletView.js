              ...
              <Card style={{ marginTop: '20px' }}>
                <Row>
                  <div className="text-center">
                    <Col span={8}>
                      <h5>
                        {row.node.urination ? 'Urination, ' : ''}{' '}
                        {row.node.bowel ? 'Bowel Movement ' : ''}
                      </h5>
                      <h5>Last Water : {row.node.lastWater ? row.node.lastWater : ''}</h5>
                      <h5>
                        Last Water Time : {row.node.lastWaterTime ? row.node.lastWaterTime : ''}
                      </h5>
                    </Col>
                    <Col span={8}>
                      <h5> {row.node.date} </h5>
                    ...
                    <Col span={8}>
                      ...
                      <h5 style={{ color: '#f5222d' }}>
                        Success : {row.node.success ? 'Yes' : 'No'}
                      </h5>
                    </Col>
                  </div>
                </Row>
