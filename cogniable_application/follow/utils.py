...
from django.db.models.fields.related import ManyToManyField, ForeignKey, CASCADE
from follow.models import Follow, models
...
def register(model, field_name=None, related_name=None, lookup_method_name='get_follows'):
    ...
    field = ForeignKey(model, related_name=related_name, null=True,blank=True,on_delete=models.CASCADE, db_index=True,)
