# Generated by Django 2.2.3 on 2019-12-24 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline', models.DateField(default=datetime.date(2020, 1, 4), verbose_name='deadline')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='objecttask_tasks', to='django_project.Task', verbose_name='task')),
            ],
            options={
