...
class Project(ProjectMixin, models.Model):
    ...
    author = models.ForeignKey(User, name=_('author'), related_name='created_projects', on_delete=models.CASCADE)
...
class Transition(models.Model):
    ...
    """
    source = models.ForeignKey(Status, verbose_name=_('source status'), related_name='sources', on_delete=models.CASCADE)
...
class Task(TaskMixin, models.Model):
    ...
    author = models.ForeignKey(User, verbose_name=_('author'), related_name='created_tasks', blank=True, on_delete=models.CASCADE)

    owner = models.ForeignKey(User, verbose_name=_('owner'), related_name='owned_tasks', null=True, blank=True, on_delete=models.CASCADE)
...
class Comment(CommentMixin, models.Model):
    """
    """
    author = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('author'), related_name="%(class)s_comments", on_delete=models.CASCADE)
...
class ObjectTask(models.Model):
    """
    """
    task = models.ForeignKey(Task, verbose_name=_('task'), related_name="%(class)s_tasks", on_delete=models.CASCADE)
